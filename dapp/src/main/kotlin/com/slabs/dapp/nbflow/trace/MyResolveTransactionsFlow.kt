package com.slabs.nbflow.trace
 ...
 */
class MyResolveTransactionsFlow(private val txHashes: Set<SecureHash>,
    ...
    /** The maximum number of transactions this api will try to download before bailing out. */
    ...
    private fun downloadDependencies(depsToCheck: Set<SecureHash>): List<SignedTransaction> {
        ...
        //
        // (1) This api leaks private data. If you download a transaction and then do NOT request a
